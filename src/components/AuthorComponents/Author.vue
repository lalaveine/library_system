  ...
  <div class="content">
    ...
    <a-form :form="form" :label-col="{ span: 5 }" :wrapper-col="{ span: 8 }" @submit="handleSubmit">
      <a-form-item label="Name:">
        <a-input
                v-decorator="['name', { rules: [{ required: true, message: 'Please input Author name!' }] }]"
                placeholder="Input Author name"
        />
      </a-form-item>

      <a-form-item label="Middle Name:">
        <a-input v-decorator="[ 'Middle Name:', { rules: [{ required: true, message: 'Please input Middle Name:!' }] } ]" placeholder="Input reader" />
      </a-form-item>
      <a-form-item label="Surname:">
        <a-input v-decorator="[ 'Surname:', { rules: [{ required: true, message: 'Please input Surname:!' }] } ]" placeholder="Input reader" />
      </a-form-item>
