  ...
  <div class="reader-input">
    ...
    <a-form :form="form" :label-col="{ span: 5 }" :wrapper-col="{ span: 8 }" @submit="handleSubmit">
      <a-form-item label="Name:">
        <a-input
          v-decorator="['title', { rules: [{ required: true, message: 'Please write  Author\'s name' }] }]"
          placeholder="Author's name"
        />
      </a-form-item>
       <a-form-item label="Middle name:">
        <a-input
          v-decorator="['Middle', { rules: [{ required: true, message: 'middle name' }] }]"
      ...
      <a-form-item label="Surname:">
            ...
            placeholder="Input surname author"
            />
      </a-form-item>
